...
export default {
  ...
  "dashboard.hero_description": "Describe an outcome. MARL OS will run it and keep an audit trail.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Save an MARL OS server as a worker.",
  "dashboard.create_remote_workspace_confirm": "Add Worker",
  "dashboard.edit_remote_workspace_title": "Edit Remote Connection",
  "dashboard.edit_remote_workspace_subtitle": "Update the MARL OS server details for this worker.",
  "dashboard.edit_remote_workspace_confirm": "Save connection",
  "dashboard.remote_workspace_title": "Remote worker",
  "dashboard.remote_workspace_hint": "Track an MARL OS server and reconnect anytime.",
  "dashboard.remote_base_url_label": "MARL OS server URL",
  "dashboard.remote_base_url_placeholder": "http://127.0.0.1:8787",
  "dashboard.remote_base_url_required": "Add a server URL to continue.",
  "dashboard.openwork_host_label": "MARL OS server URL",
  "dashboard.openwork_host_placeholder": "https://your-server.openwork.app",
  "dashboard.openwork_host_hint": "Use the URL shared by your MARL OS server.",
  ...
  "dashboard.remote_mode_openwork_alpha": "MARL OS server",
  ...
  "session.placeholder": "Ask MARL OS...",
  "session.run": "Run",
  ...
  "skills.host_only_error": "Skill management requires a local worker or connected MARL OS server.",
  ...
  "skills.connect_host_to_load": "Connect an MARL OS server to load skills.",
  ...
  // ==================== Apps (MCP) ====================
  "mcp.apps_title": "Apps",
  "mcp.apps_subtitle": "Connect your favorite tools so MARL OS can use them on your behalf.",
  ...
  "mcp.mcps_title": "Apps",
  "mcp.connect_mcp_hint": "Connect apps to expand what MARL OS can do.",
  ...
  "mcp.mcps_label": "Apps",
  "mcp.mcps_description": "Connect apps to expand what MARL OS can do.",
  ...
  "mcp.auth.step2_title": "Authorize MARL OS",
  ...
  "settings.updates_description": "Keep MARL OS up to date.",
  ...
  "settings.advanced_description": "Reset MARL OS local state to retest onboarding.",
  "settings.reset_onboarding": "Reset onboarding",
  "settings.reset_onboarding_description": "Clears MARL OS preferences and restarts the app.",
  ...
  "settings.updates_hint": "Keep MARL OS up to date.",
  ...
  "settings.advanced_hint": "Reset MARL OS local state to retest onboarding.",
  "settings.reset_onboarding_label": "Reset onboarding",
  "settings.reset_onboarding_hint": "Clears MARL OS preferences and restarts the app.",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "Starting MARL OS server...",
  "onboarding.searching_host": "Connecting to MARL OS server...",
  ...
  "onboarding.remote_workspace_title": "Connect to MARL OS server",
  "onboarding.remote_workspace_description": "Connect to an MARL OS server to access a worker from anywhere.",
  "onboarding.remote_workspace_action": "Connect",
  "onboarding.remote_workspace_card_title": "Connect a remote worker",
  "onboarding.remote_workspace_card_description": "Connect to an MARL OS server to access a shared worker.",
  "onboarding.advanced_openwork_host": "MARL OS server",
