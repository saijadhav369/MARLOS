...
export default {
  ...
  "dashboard.hero_description": "描述一个目标。MARL OS 将运行它并保留审计记录。",
  ...
  "dashboard.remote_mode_openwork_alpha": "MARL OS 服务器",
  ...
  "session.placeholder": "向 MARL OS 提问...",
  "session.run": "运行",
  ...
  "skills.host_only_error": "技能管理需要本地工作区或已连接的 MARL OS 服务器。",
  ...
  "skills.connect_host_to_load": "连接 MARL OS 服务器以加载技能。",
  ...
  "mcp.mcps_title": "MCPs",
  "mcp.connect_mcp_hint": "连接 MCP 服务器以扩展 MARL OS 的功能。",
  ...
  "mcp.mcps_label": "MCPs",
  "mcp.mcps_description": "连接 MCP 服务器以扩展 MARL OS 的功能。",
  "mcp.configured": "已配置",
  "mcp.updated": "更新时间",
  ...
  "mcp.auth.step2_title": "授权 MARL OS",
  ...
  "settings.done": "完成",
  "settings.updates": "更新",
  "settings.updates_description": "保持 MARL OS 为最新版本。",
  ...
  "settings.advanced_description": "重置 MARL OS 本地状态以重新测试入门流程。",
  ...
  "settings.reset_onboarding_warning": "清除 MARL OS 本地偏好设置和工作区入门标记。",
  ...
  "settings.updates_hint": "保持 MARL OS 为最新版本。",
  ...
  "settings.advanced_hint": "重置 MARL OS 本地状态以重新测试入门流程。",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "正在启动 MARL OS 服务器...",
  "onboarding.searching_host": "正在连接 MARL OS 服务器...",
  ...
  "onboarding.remote_workspace_title": "连接 MARL OS 服务器",
  "onboarding.remote_workspace_description": "连接 MARL OS 服务器以随时访问工作区。",
  "onboarding.remote_workspace_action": "连接",
  "onboarding.remote_workspace_card_title": "连接远程工作区",
  "onboarding.remote_workspace_card_description": "连接 MARL OS 服务器以访问共享工作区。",
  "onboarding.advanced_openwork_host": "MARL OS 服务器",
